...
protected:
    ...
    int vocab_max_size;
    int vocab_size;
    //Modif 11/09 taille du tagset
    int tagSet_size;
    //Modif 10/09 taille des vecteurs correpondant à la representation phrastique des mots du vocab 
    int phRep_size;
    int train_words;
    int train_cur_pos;
    int counter;
    ...
    //Modif 10/09 representation phrastique
    int **phRep;
    //Modif 111/09
    struct tagSet_tag *tagSet; 
...
public:
	...
	vocab_size=0;
        tagSet_size=0;
        //Modif 10/09 Initialisation de la taille phRep
        phRep_size=0;
        phRep=NULL;
        tagSet=NULL;
    ...
    //Modif 15/09
    void setTestTag(char *str);
    //Modif 11/09
    void setTagSet(char *str);
    void setTrainTag(char *str);
    void setValidTag(char *str);
    ...
    //Modif 11/09
    int searchTagSet(char *tag);
    int readTagIndex(FILE *fin,int wordIndexndex) ;
